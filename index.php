...
<head>
    ...
    <!-- Title -->
    <title>Scouts recruitment system</title>
...
<body>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="fitnessNav">
                        ...
                        <!-- Nav brand -->
                        <a href="index.html" class="nav-brand"><img src="img/core-img/images.png" alt=""></a>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/scouts.jpg);">
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="hero-slides-content">
                                ...
                                <a href="signup.php" class="btn fitness-btn wel-btn" data-animation="fadeInUp" data-delay="700ms">Get a membership</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="hero-slides-content">
                                ...
                                <p data-animation="fadeInUp" data-delay="400ms"></p>
                                <a href="signup.php" class="btn fitness-btn wel-btn" data-animation="fadeInUp" data-delay="700ms">Get a membership</a>s
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="single-price-table mb-100">
                        ...
                        <div class="price-table-content">
                            ...
                            <!-- btn -->
                            <a href="#" class="btn fitness-btn mt-30">Explore</a>
                        </div>
                    </div>
                </div>
